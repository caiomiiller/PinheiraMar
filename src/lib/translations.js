...
export const TRANSLATIONS = {
  pt: {
    ...
    /* search */
    search_checkin: 'Chegada', search_checkout: 'Saída',
    ...
    /* category pills */
    cat1: 'Frente Mar', cat2: 'Residenciais', cat3: 'Estacionamento',
  ...
  es: {
    ...
    search_checkin: 'Llegada', search_checkout: 'Salida',
    ...
    cat1: 'Frente al mar', cat2: 'Propiedades', cat3: 'Estacionamiento',
  ...
  en: {
    ...
    search_checkin: 'Arrival', search_checkout: 'Departure',
    ...
    cat1: 'Oceanfront', cat2: 'Properties', cat3: 'Parking',
