...
export function Financeiro({ data, go }) {
  ...
  const KPI = ({ label, value, sub, accent }) => (
    <Card style={{ padding: 18 }}>
      ...
      <div className="pm-fin-kpi-value" style={{ fontSize: 'clamp(14px, 1.3vw, 19px)', fontWeight: 700, fontFamily: F.disp, color: accent ? C.coralDeep : C.ink, lineHeight: 1.15, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{value}</div>
