...
export function Admin({ data, update, initialResidencialId }) {
  ...
  // permite recolher a barra lateral para ganhar largura extra em ecrãs de
  // conteúdo mais apertado, como o calendário de reservas com muitos dias/apartamentos
    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: F.sans, color: C.ink, background: C.espuma }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {/* Reservas ganha a largura toda disponível (sem o limite de 1180px das
            outras abas) — o calendário usa esse espaço para caber todos os
            dias do mês sem rolagem horizontal */}
